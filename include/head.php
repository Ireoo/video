<div class="meun">
    <ul class="meun">
        <div<?php if(is_array($o)) {echo ' class="login"';} ?>>
            ...
            if(is_array($o)) {
                ?>
                <a target="_blank" href="/i"><img src="http://ireoo.com/<?php echo $o['avatar_large']; ?>" /><span><?php echo $o['username']; ?></span></a><a><span>余额：<?php echo $o['money']; ?></span></a><a href="/<?php echo $o['id']; ?>"><span>直播</span></a><a href="<?php echo HOST_URL; ?>?loginout=yes"><span>退出</span></a>
            <?php
            }else{
                ?>
